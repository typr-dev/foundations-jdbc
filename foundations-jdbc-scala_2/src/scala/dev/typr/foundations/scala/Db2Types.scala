...
class Db2Types {
  ...
  def decimal(precision: Int, scale: Int): Db2Type[java.math.BigDecimal] =
    JavaDb2Types.decimal(precision, scale)

  def numeric(precision: Int, scale: Int): Db2Type[java.math.BigDecimal] =
    JavaDb2Types.numeric(precision, scale)

  def decfloat(precision: Int): Db2Type[java.math.BigDecimal] =
