...
/** Scala string interpolator for creating SQL Fragments.
  ...
  * Usage:
  * {{{
  * import dev.typr.foundations.scala.FragmentInterpolator._
  *
...
object FragmentInterpolator {
  implicit class FragmentInterpolatorOps(private val sc: StringContext) extends AnyVal {
