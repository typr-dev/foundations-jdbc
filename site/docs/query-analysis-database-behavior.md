...
The analyzer checks whether your code handles nullable columns correctly: if the database says a column is nullable, your type should use `.opt()`. However, the reliability of this information varies by database.
...
Since DuckDB reports all columns as nullable, outer join nullability adjustments are irrelevant.
