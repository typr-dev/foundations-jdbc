...
val venueParser: RowParserNamed<Venue> = RowParser.namedBuilder<Venue>()
...
val eventParser: RowParserNamed<Event> = RowParser.namedBuilder<Event>()
...
val ticketParser: RowParserNamed<Ticket> = RowParser.namedBuilder<Ticket>()
...
val eventSummaryParser: RowParserNamed<EventSummary> = RowParser.namedBuilder<EventSummary>()
