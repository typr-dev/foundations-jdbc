...
val venueCodec: RowCodecNamed<Venue> = RowCodec.namedBuilder<Venue>()
    ...
    .field("tags", DuckDbTypes.varchar.list(), Venue::tags)
...
val eventCodec: RowCodecNamed<Event> = RowCodec.namedBuilder<Event>()
    ...
    .field("tags", DuckDbTypes.varchar.list(), Event::tags)
    .field("ratings", DuckDbTypes.double_.list(), Event::ratings)
    .build(::Event)
...
val ticketCodec: RowCodecNamed<Ticket> = RowCodec.namedBuilder<Ticket>()
    ...
    .field("seat_numbers", DuckDbTypes.integer.list(), Ticket::seatNumbers)
    .build(::Ticket)
