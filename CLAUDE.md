...
- **NEVER PUSH TO MAIN. EVER.** Before ANY git push, ALWAYS run `git branch --show-current` and VERIFY you are NOT on main. If you need to create a PR, create a feature branch FIRST.
