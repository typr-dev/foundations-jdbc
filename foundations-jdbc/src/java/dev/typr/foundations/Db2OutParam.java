...
/**
 * OUT/INOUT parameter codecs for DB2 types. Each instance handles both registration and reading.
 */
public interface Db2OutParam<A> extends DbOutParam<A> {
  ...
  // Date/time types
  Db2OutParam<LocalDate> readLocalDate =
      of(
          Types.DATE,
          (stmt, i) -> {
  ...
  Db2OutParam<LocalTime> readLocalTime =
      of(
          Types.TIME,
          (stmt, i) -> {
  ...
  Db2OutParam<LocalDateTime> readLocalDateTime =
      of(
          Types.TIMESTAMP,
          (stmt, i) -> {
  ...
  Db2OutParam<Instant> readInstant =
      of(
          Types.TIMESTAMP,
          (stmt, i) -> {
            var ts = stmt.getTimestamp(i);
  ...
  Db2OutParam<String> readXmlAsString =
      of(
          Types.SQLXML,
          (stmt, i) -> {
