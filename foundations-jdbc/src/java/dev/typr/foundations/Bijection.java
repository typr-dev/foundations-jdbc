...
public interface Bijection<T, TT> {
   ...
   *
   * <p>This is used for type-safe boolean operations on {@link dev.typr.foundations.dsl.SqlExpr}.
   * The method only compiles when called in a context where T = Boolean, providing compile-time
   * type safety.
   *
   * <p>Example usage:
   *
   ...
   *
   * <p>This is used for type-safe string operations on {@link dev.typr.foundations.dsl.SqlExpr}.
   * The method only compiles when called in a context where T = String, providing compile-time type
   * safety.
   *
   * <p>Example usage:
   *
