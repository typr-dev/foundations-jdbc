...
public interface OracleTypes {
  ...
  static <Row> OracleType<Row> jsonArrayEncoded(RowCodec<Row> codec) {
  ...
  static <Row> OracleType<List<Row>> jsonArrayEncodedList(RowCodec<Row> codec) {
  ...
  static <Row> OracleType<Row> jsonObjectEncoded(RowCodecNamed<Row> codec) {
  ...
  static <Row> OracleType<List<Row>> jsonObjectEncodedList(RowCodecNamed<Row> codec) {
