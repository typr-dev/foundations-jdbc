 ...
 */
public record DuckDbArrayCodec<A>(Function<Object, A> fromElement, Function<A, String> toElement) {
  ...
  static <A> DuckDbArrayCodec<A> fromReadAndStringifier(
    ...
    return new DuckDbArrayCodec<>(read::fromJdbcValue, a -> stringifier.encode(a, false));
  }
  ...
  public <B> DuckDbArrayCodec<B> map(Function<A, B> read, Function<B, A> write) {
    return new DuckDbArrayCodec<>(
        obj -> read.apply(fromElement.apply(obj)), b -> toElement.apply(write.apply(b)));
  }
}
