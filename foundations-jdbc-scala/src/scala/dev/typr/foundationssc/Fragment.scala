...
object Fragment {
  ...
  def insertIntoGeneratedKeys[Row, Out](
    ...
    new RowTemplate.GeneratedKeys(dev.typr.foundations.Fragment.insertIntoGeneratedKeys(table, codec.underlying, generatedColumns.toArray, parser.underlying, except*))

  /** Convenience for the common single-generated-column insert (AUTO_INCREMENT / IDENTITY /
    * GENERATED BY DEFAULT AS IDENTITY). Excludes the generated column from the INSERT's VALUES list. */
  def insertIntoGeneratedKey[Row, Out](
    ...
    new RowTemplate.GeneratedKeys(dev.typr.foundations.Fragment.insertIntoGeneratedKeys(
      table, codec.underlying, Array(generatedColumn), parser.underlying, generatedColumn))
