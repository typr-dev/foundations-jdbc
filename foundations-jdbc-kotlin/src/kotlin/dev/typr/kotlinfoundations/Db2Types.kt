...
open class Db2Types {
    ...
    open fun decimal(precision: Int, scale: Int): Db2Type<java.math.BigDecimal> =
        JavaDb2Types.decimal(precision, scale)

    open fun numeric(precision: Int, scale: Int): Db2Type<java.math.BigDecimal> =
        JavaDb2Types.numeric(precision, scale)

    open fun decfloat(precision: Int): Db2Type<java.math.BigDecimal> =
        JavaDb2Types.decfloat(precision)

    open fun char_(length: Int): Db2Type<String> = JavaDb2Types.char_(length)

    open fun varchar(length: Int): Db2Type<String> = JavaDb2Types.varchar(length)

    open fun clob(length: Int): Db2Type<String> = JavaDb2Types.clob(length)

    open fun graphic(length: Int): Db2Type<String> = JavaDb2Types.graphic(length)

    open fun vargraphic(length: Int): Db2Type<String> = JavaDb2Types.vargraphic(length)

    open fun dbclob(length: Int): Db2Type<String> = JavaDb2Types.dbclob(length)

    open fun binary(length: Int): Db2Type<ByteArray> = JavaDb2Types.binary(length)

    open fun varbinary(length: Int): Db2Type<ByteArray> = JavaDb2Types.varbinary(length)

    open fun blob(length: Int): Db2Type<ByteArray> = JavaDb2Types.blob(length)

    open fun timestamp(scale: Int): Db2Type<java.time.LocalDateTime> = JavaDb2Types.timestamp(scale)
