...
public class BatchOperations {
    ...
    RowSqlTemplate.Update<Product> insertAll = Fragment.of("INSERT INTO product (")
    ...
    RowSqlTemplate.Update<Product> insertAutoId = Fragment.of("INSERT INTO product (name, price, created_at) VALUES (")
