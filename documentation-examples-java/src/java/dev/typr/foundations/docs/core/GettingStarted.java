...
public class GettingStarted {
    ...
    void example() throws SQLException {
        ...
        var ds = SimpleDataSource.create(DuckDbConfig.inMemory().build());
        var tx = ds.transactor();

        // Define a row parser
        RowParser<City> cityParser = RowParser.<City>builder()
        ...
        List<City> cities = Fragment.of("SELECT name, population FROM city ORDER BY population DESC")
