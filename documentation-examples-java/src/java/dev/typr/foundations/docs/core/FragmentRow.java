...
public class FragmentRow {
    ...
    RowSqlTemplate<Product, Product> insertTemplate = Fragment.of("INSERT INTO product (")
    ...
    RowSqlTemplate<Product, Product> insertWithSequenceTemplate = Fragment.of("INSERT INTO product (")
